...
Shadowsocks-libev: 基于shadowsocks/shadowsocks-libev源码为ER-X(-SFP)编译的3.2.0版本，包含ss-redir和ss-local
Kcptun: 引用xtaci/kcptun项目20180316版本，kcptun-linux-mipsle-20180316.tar.gz

安装:
1. 下载或clone本项目，并拷贝至路由器
2. 按照实际情况调整配置文件shadowsocks.json和kcp.json的参数
3. 在路由器chmod +x install.sh后执行安装脚本
...
终止 sudo /etc/init.d/shadowsocks stop
